            ...
            <Menu>
              ...
              >
                <Menu.ItemGroup key='AboutUs' title='Information'>
                  <Menu.Item key='Folder1'> <Link to="/page1">Folder 1</Link></Menu.Item>
                  <Menu.Item key='Folder2'> <Link to="/page2">Folder 2</Link></Menu.Item>
                  <Menu.Item key='Folder3'> <Link to="/page3">Folder 3</Link></Menu.Item>
                </Menu.ItemGroup>
              </SubMenu>
            </Menu>
          </Sider>
